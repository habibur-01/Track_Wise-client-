                ...
                >
                        ...
                        <div className="flex justify-center w-full h-[800px] items-center ">
                            <div className="text-[#e4eeee] w-[50%] h-full flex justify-center items-center ">
                                <div className="space-y-6 w-[80%] lg:pl-10">
                                    <p className="text-xl bg-gradient-to-r from-[#6648ff] via-[#7fefda] to-[#45f9d7] inline-block text-transparent bg-clip-text">Track Transport</p>
                                    <h1 className="font-bold text-5xl ">Track your university transport location </h1>
                                    <p className="text-2xl">Bus is gone or not!! {"Let's"} start <br />  to track your bus.</p>
                                    <button className="px-4 py-3 text-white bg-[#6648ff] rounded-md font-medium  hover:font-semibold">{"Let's Track"}</button>
                                </div>
                            </div>
                            <div className="w-[50%]">
                    ...
                    <SwiperSlide>
                        <div className="flex justify-center w-full h-[800px] items-center">
                            <div className="text-[#e4eeee] w-[50%] h-full flex justify-center items-center ">
                                <div className="space-y-6 w-[80%] lg:pl-10">
                                    <p className="text-xl bg-gradient-to-r from-[#6648ff] via-[#7fefda] to-[#45f9d7] inline-block text-transparent bg-clip-text">Registration</p>
                                    <h1 className="font-bold text-5xl">Easily make your tranport registration </h1>
                                    <p className="text-2xl">Bus is gone or not!! {"Let's"} start <br />  to track your bus.</p>
                                    <button className="px-4 py-3 text-white bg-[#6648ff] rounded-md  font-medium  hover:font-semibold">See more...</button>
                                </div>
                            </div>
                            <div className="w-[50%]">
