import pic1 from "../../../assets/logos/3925869.jpg"

const Schedule = () => {
    return (
        <div className="md:flex md:justify-center md:items-center h-[800px]">
            <div className="w-[50%] order-2 flex justify-center ">
            ...
            <div className="w-[50%] flex justify-center items-center">
                <div className="w-[80%] ">
                    <div>
                        ...
                        <h1 className="text-3xl font-semibold"> Explore Transport Schedule</h1>
